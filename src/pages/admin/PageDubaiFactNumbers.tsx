...
import {
  useCreatePageDubaiFactNumbers,
  useUpdatePageDubaiFactNumbers,
} from '@/services/mutation'
import { useGetPageDubaiFactNumbers } from '@/services/queries'
...
const PageDubaiFactNumbers = () => {
  const navigate = useNavigate()
  const { data: page } = useGetPageDubaiFactNumbers()
    ...
    <main className='flex flex-1 flex-col gap-4 p-4 lg:gap-6 lg:p-6'>
      <div className='flex flex-col gap-4'>
        ...
        <h1 className='text-lg font-bold md:text-2xl'>
          {page
            ? 'Edit Dubai Fact Numbers Page'
            : 'Add Dubai Fact Numbers Page'}
        </h1>
      </div>
      <div
...
export default PageDubaiFactNumbers
