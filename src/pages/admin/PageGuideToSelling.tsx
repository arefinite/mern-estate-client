...
import {
  useCreatePageGuideToSelling,
  useUpdatePageGuideToSelling,
} from '@/services/mutation'
import { useGetPageGuideToSelling } from '@/services/queries'
...
const PageGuideToSelling = () => {
  const navigate = useNavigate()
  const { data: page } = useGetPageGuideToSelling()
    ...
    <main className='flex flex-1 flex-col gap-4 p-4 lg:gap-6 lg:p-6'>
      <div className='flex flex-col gap-4'>
        ...
        <h1 className='text-lg font-bold md:text-2xl'>
          {page ? 'Edit Guide To Selling Page' : 'Add Guide To Selling Page'}
        </h1>
      </div>
      <div
...
export default PageGuideToSelling
