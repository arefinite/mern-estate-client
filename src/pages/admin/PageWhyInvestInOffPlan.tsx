...
import {
  useCreatePageWhyInvestOffPlan,
  useUpdatePageWhyInvestOffPlan,
} from '@/services/mutation'
import { useGetPageWhyInvestOffPlan } from '@/services/queries'
...
const PageWhyInvestInOffPlan = () => {
  const navigate = useNavigate()
  const { data: page } = useGetPageWhyInvestOffPlan()
    ...
    <main className='flex flex-1 flex-col gap-4 p-4 lg:gap-6 lg:p-6'>
      <div className='flex flex-col gap-4'>
        ...
        <h1 className='text-lg font-bold md:text-2xl'>
          {page
            ? 'Edit Why Invest in Off Plan Page'
            : 'Add Why Invest in Off Plan Page'}
        </h1>
      </div>
      <div
...
export default PageWhyInvestInOffPlan
