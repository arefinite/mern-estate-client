...
import { useCreateBlog } from '@/services/mutation'
...
const CreateBlog = () => {
  ...
  const { mutateAsync: createBlogSync, isPending: isCreating } = useCreateBlog()
  ...
  return (
    <main className='flex flex-1 flex-col gap-4 p-4 lg:gap-6 lg:p-6'>
      <div className='flex flex-col gap-4'>
        <AdminSitePath items={false} currentPage='Create Blog' />
        <h1 className='text-lg font-bold md:text-2xl'>Add Blog</h1>
      </div>
      <div
