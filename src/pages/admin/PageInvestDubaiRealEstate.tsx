...
import {
  useCreatePageInvestDubaiEstate,
  useUpdatePageInvestDubaiEstate,
} from '@/services/mutation'
import { useGetPageInvestDubaiEstate } from '@/services/queries'
...
const PageInvestDubaiRealEstate = () => {
  const navigate = useNavigate()
  const { data: page } = useGetPageInvestDubaiEstate()
    ...
    <main className='flex flex-1 flex-col gap-4 p-4 lg:gap-6 lg:p-6'>
      <div className='flex flex-col gap-4'>
        ...
        <h1 className='text-lg font-bold md:text-2xl'>
          {page
            ? 'Edit Invest in Dubai Real Estate Page'
            : 'Add Invest in Dubai Real Estate Page'}
        </h1>
      </div>
      <div
...
export default PageInvestDubaiRealEstate
