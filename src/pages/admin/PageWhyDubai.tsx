...
import {
  useCreatePageWhyDubai,
  useUpdatePageWhyDubai,
} from '@/services/mutation'
import { useGetPageWhyDubai } from '@/services/queries'
...
const PageWhyDubai = () => {
  ...
  const { data: page } = useGetPageWhyDubai()
    ...
    <main className='flex flex-1 flex-col gap-4 p-4 lg:gap-6 lg:p-6'>
      <div className='flex flex-col gap-4'>
        ...
        <h1 className='text-lg font-bold md:text-2xl'>
          {page ? 'Edit Why Dubai Page' : 'Add Why Dubai Page'}
        </h1>
      </div>
      <div
