...
import { useCreatePageAbout, useUpdatePageAbout } from '@/services/mutation'
import { useGetPageAbout } from '@/services/queries'
...
const PageAbout = () => {
  ...
  const { data: page } = useGetPageAbout()
    ...
    <main className='flex flex-1 flex-col gap-4 p-4 lg:gap-6 lg:p-6'>
      <div className='flex flex-col gap-4'>
        ...
        <h1 className='text-lg font-bold md:text-2xl'>
          {page ? 'Edit About Page' : 'Add About Page'}
        </h1>
      </div>
      <div
